...
cit - Delete everything wrapped from tag. Example: <p>Hello World</p>. Cursor must
be between <p> and </p> tags and command will delete Hello World

ci + "charachter" - Example: function sum(arg1, arg2). Cursor must be placed between
...
:sb and number of buffer - horizontal split window. 
Example: “:sb2”
:vert and number of buffer - vertical split window
Example: “:vert sb2”
